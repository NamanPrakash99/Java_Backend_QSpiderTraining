...
public class StepsToconnectDb {
	public static void main(String[] args) {
		...
		try {
			...
			String ins = "insert into student values(3,'Ravi','ECE'),(4,'Divyansh','MEC')";
			String upd = "update student set name='Shreya' where id=2";
			String del = "delete from student where id=2";
