    ...
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <body>
            <nav class="navbar">
                ...
                <a href="<c:url value='/tasks'/>" class="btn btn-secondary">&#8592; Back to Tasks</a>
            </nav>
            <div class="container">
                <div class="form-card">
                    <h2>Add New Task</h2>
                    ...
                    <form:form method="post" action="${pageContext.request.contextPath}/tasks/save"
                        modelAttribute="task" enctype="multipart/form-data">
                        ...
                        <div class="form-buttons">
                            ...
                            <a href="<c:url value='/tasks'/>" class="btn btn-secondary">&#10006; Cancel</a>
                        </div>
                    </form:form>
                </div>
            </div>
